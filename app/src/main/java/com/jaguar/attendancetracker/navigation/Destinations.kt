...
enum class Destinations(
    ...
    DAYVIEW("Day View", R.drawable.day_view, "/dayview"), DASHBOARD(
        "Dashboard",
        Icons.Outlined.Home,
        "/dashboard"
    ),
    ...
    SUBJECT("Subject", Icons.AutoMirrored.Outlined.List, "/subject", false), SETTINGS(
        "Settings",
        Icons.Outlined.Settings,
        "/settings",
        false
    ),
    IM_EXPORT("Import-Export", Icons.Outlined.Settings, "/im-export", false), HELP(
        "Help",
        Icons.Outlined.Settings,
        "/help",
        false
